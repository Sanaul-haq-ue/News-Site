            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-8 offset-2">
                        <div class="card ">
                            <form class="p-2" action="{{ route('blogs.update',$blog->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-12">
                                    <label class="form-label" id="title">Title</label>
                                    <input type="text" value="{{ $blog->title }}" name="title" class="form-control p-4" required="required"/>
                                </div>

                                <div class="col-12">
                                    <label class="form-label mt-2" id="slug">Slug</label>
                                    <input type="text" value="{{ $blog->title }}" name="slug" class="form-control p-4"/>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="date" name="date" value="{{ $blog->date }}" class="form-control" required="required"/>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-6 form-group pl-4">
                                            ...
                                            <div class="form-control row  mr-1">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="addSlider" id="inlineRadio1" value="1" {{ $blog->addSlider == '1'? 'checked': null }}>
                                                    <label class="form-check-label" for="inlineRadio1">Active</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="addSlider" id="inlineRadio2" value="0" {{ $blog->addSlider == '0'? 'checked': null }}>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" name="description" id="description" cols="30" rows="10" required="required">{{ $blog->description }}</textarea>
                                </div>
